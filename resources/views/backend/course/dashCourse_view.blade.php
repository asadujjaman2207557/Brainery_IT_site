                    ...
                    <section class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3>Courses List
                                    <a class="btn btn-success float-right btn-sm" href="{{ route('courses.add') }}"><i
                                    ...
                                    <tbody>
                                        @foreach ($allData as $key => $feature)
                                            <tr>
                                                ...
                                                <td class="ellipsis "> <span> {{ $feature->price }} </span></td>
                                                ...
                                                <td ><a title="Edit" class="btn btn-sm btn-primary"
                                                        href="{{ route('courses.edit', $feature->id) }}"><i
                                                            class="fa fa-edit"></i></a>
                                                    {{--  <a title="Delete" id="delete" class="btn btn-sm btn-danger"
                                                        href="{{ route('services.delete', $feature->id) }}"><i
                                                        class="fa fa-trash"></i></a>  --}}
                                                    <form method="POST" action="{{ url('/courses/delete' . '/' . $feature->id) }}">
                                                        {{ method_field('DELETE') }}
                                                        {{ csrf_field() }}
