                ...
                <section class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3>Add Courses <a class="btn btn-success float-right btn-sm"
                                    href="{{route('courses.view')}}"><i class="fa fa-arrow-left"></i> Go back</a></h3>
                        </div><!-- /.card-header -->

                        <div class="card-body">
                            <form method="POST" action="{{route('courses.store')}}" id="myForm"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="number" class="form-control" name="price" rows="4"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <img src="{{(!empty($editData->image))?url('public/images/svg/'.@$editData->image):url('public/upload/no_image.png')}}"
                                                ...
                                                <p id="fileName">{{ $editData->image ?? 'Select SVG File Only' }}</p>
                                        </div>
                                    </div>
