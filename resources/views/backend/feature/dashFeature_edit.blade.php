            ...
            <div class="row">
                ...
                <section class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{route('features.update',$editData->id)}}" id="myForm"
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="file" class="form-control" name="image" id="image"
                                                placeholder="Upload Image" value="public/images/features/{{$editData->image}}">
                                        </div>

                                        <div class="form-group col-md-6">
                                            {{--  {{url('public/images/features/'.@$f_card->image)}}  --}}
                                            <img src="{{(!empty($editData->image))?url('public/images/features/'.@$editData->image):url('public/upload/no_image.png')}}"
