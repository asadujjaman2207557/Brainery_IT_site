...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Manage Feature</h1>
                </div><!-- /.col -->
                ...
                <section class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3>Feature List
                                @if($countfeature<1) <a class="btn btn-success float-right btn-sm"
                                    href="{{route('feature.add')}}"><i class="fa fa-plus-circle"></i> Add
                                    Feature</a>
                                    @endif
                            </h3>
                        </div><!-- /.card-header -->
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a title="Edit" class="btn btn-sm btn-primary"
                                                href="{{route('features.edit',$feature->id)}}"><i class="fa fa-edit"></i></a>
