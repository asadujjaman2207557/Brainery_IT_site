                ...
                <section class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3>Edit Portfolio <a class="btn btn-success float-right btn-sm"
                                    href="{{route('portfolios.view')}}"><i class="fa fa-arrow-left"></i> Go back</a></h3>
                        </div><!-- /.card-header -->

                        <div class="card-body">
                            <form method="POST" action="{{route('portfolios.update',$editData->id)}}" id="myForm"
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="file" class="form-control" name="image" id="image"
                                                placeholder="Upload Image" value="public/images/portfolio/{{$editData->image}}">
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <img src="{{(!empty($editData->image))?url('public/images/portfolio/'.@$editData->image):url('public/upload/no_image.png')}}"
                                                ...
                                                <p id="fileName">public/images/portfolio/{{ $editData->image ?? 'No image selected' }}</p>
                                        </div>
                                    </div>
